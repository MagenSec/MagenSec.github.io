    ...
    <div class="row row-deck row-cards">
        ...
        <div class="card">
          <div class="card-body">
            <div class="d-flex align-items-center">
              <div class="subheader">Avg CPU Utilization (24h)</div>
            </div>
      ...
      <div class="col-sm-6">
        <div class="card">
          <div class="card-body">
            <div class="d-flex align-items-center">
              <div class="subheader">Avg Memory Usage (24h)</div>
            </div>
            <div class="h1 mt-2 mb-0">${summary.avgMem} MB</div>
          </div>
        </div>
      </div>
...
function renderTimeSeriesChart(elementId, title, data, dataKey, unit) {
    ...
    const dataArray = [['Time', title]];
    data.forEach(d => {
        dataArray.push([new Date(d.timestamp), d[dataKey]]);
    });
