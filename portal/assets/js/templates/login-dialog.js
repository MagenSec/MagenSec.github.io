 ...
 * 
 * HTML template for the Google OAuth login dialog.
 * Provides a modal overlay with Google sign-in button.
 */
...
window.MagenSecTemplates.loginDialog = `
    <div id="login-overlay" data-login-overlay="true" class="fixed inset-0 bg-gray-900 flex items-center justify-center z-50">
