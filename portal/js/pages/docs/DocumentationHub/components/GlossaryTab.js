export function GlossaryTab(html) {
    const terms = [
        ...
        { term: 'Hygiene Score', definition: 'Your organization\u2019s overall security hygiene measure (0\u2013100). Higher is better. Comes with a letter grade: A (90\u2013100), B (80\u201389), C (70\u201379), D (60\u201369), F (0\u201359). Shown on the Home dashboard.' },
        { term: 'Risk Score', definition: 'A per-device measure (0\u2013100) of endpoint risk. Higher means MORE risk. It reflects vulnerabilities, exploit indicators, risky or outdated software, and whether the device is actively reporting.' },
        ...
        { term: 'Device check-in', definition: 'A regular status update from the MagenSec client on your device to the portal. Used to show whether a device is online, delayed, or offline.' },
        { term: 'Security metadata', definition: 'Security information collected from your devices, such as configuration, installed software, and protection status. Used to calculate scores and generate findings. Does not include personal files or browsing data.' },
        { term: 'Probe', definition: 'A Business plan response action that asks a device for a fresh security status check.' },
