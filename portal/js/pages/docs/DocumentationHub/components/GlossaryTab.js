export function GlossaryTab(html) {
    const terms = [
        ...
        { term: 'Probe', definition: 'A Response action that collects a comprehensive security posture report from a device on demand. Available on Business plans via the Response page.' },
