    ...
    return html`
        <div class="row">
            <div class="col-lg-8">
                ...
                <p class="text-muted" style="margin-bottom:16px;">Every score in MagenSec is generated by <strong>MAGI</strong> — your AI Security Officer. MAGI's proprietary intelligence engine continuously analyzes your devices, vulnerabilities, compliance posture, and remediation patterns to produce scores that reflect your true security health. These are not simple rule-based calculations — they are the output of an adaptive AI system that accounts for the full context of your organization's risk profile.</p>
                ...
                <div class="card mb-4 border-primary" style="background:linear-gradient(135deg,rgba(0,84,166,.04),rgba(0,84,166,.01));">
                    <div class="card-body">
                        ...
                        <p class="mb-2">Your top-level security health number (0–100). Generated daily by MAGI's AI engine through deep analysis of your entire security landscape — threats, compliance, remediation effectiveness, and fleet health. This is the single number to watch: it tells you whether your organisation is trending toward resilience or risk, and whether you’re positioned well for cyber insurance.</p>
                ...
                <p>MAGI's AI engine evaluates your posture through these four analytical dimensions. Each captures a different aspect of your security health, and MAGI synthesizes them into the Cyber Hygiene Score using adaptive intelligence. When your Hygiene Score changes, check which dimension MAGI flagged.</p>
                ...
                <div class="card mb-3">
                    <div class="card-body">
                        ...
                        <p class="mb-2">How exposed your devices are to known vulnerabilities. MAGI's AI evaluates the full context of each vulnerability — severity, real-world exploitability, how long it has remained unpatched, and whether it appears in the CISA Known Exploited Vulnerabilities catalog. The longer a serious vulnerability sits unresolved, the more MAGI's analysis reflects the growing risk.</p>
                ...
                <div class="card mb-3">
                    <div class="card-body">
                        ...
                        <p class="mb-2">How closely your controls and configurations align with CIS Controls v8.1 and NIST CSF 2.0. MAGI's AI maps your security posture against these frameworks and evaluates gaps by their real-world impact — a high-priority control gap carries more significance than a low-priority one.</p>
