                            ...
                            <div class="row g-2 align-items-center">
                                ...
                                <div class="col-auto ms-auto d-print-none">
                                    <div class="btn-list">
                                        ...
                                        <button class="btn" title="Open device security dashboard as seen by the device owner" onclick=${() => {
                                            const orgId = orgContext.getCurrentOrg()?.orgId || '';
                                            const url = `#!/siteadmin/review?orgId=${encodeURIComponent(orgId)}&deviceId=${encodeURIComponent(this.state.deviceId)}`;
