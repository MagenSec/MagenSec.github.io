            ...
            <div class="card" style="border-top:3px solid var(--tblr-primary);">
                <div class="card-body text-center pt-5 pb-5 px-4">
                    ...
                    <div class="d-flex gap-2 justify-content-center flex-wrap mb-3">
                        <a href="mailto:support@magensec.app?subject=Upgrade%20Inquiry%20%E2%80%94%20${encodeURIComponent(name)}" class="btn btn-primary">
                            <i class="ti ti-mail me-1"></i> Contact Us to Upgrade
                        </a>
                        <a href="mailto:support@magensec.app?subject=Demo%20Request%20%E2%80%94%20${encodeURIComponent(name)}" class="btn btn-outline-secondary">
