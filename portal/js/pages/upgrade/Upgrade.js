...
const FEATURE_CATALOG = {
    ...
    MAGI: { label: 'Officer MAGI', icon: 'ti-message-chatbot', accentColor: 'purple', headline: 'AI security officer for your team', description: 'Get mission briefings and guided remediation from your telemetry.', planKey: 'BusinessPlus' },
    ...
    InsuranceReadiness: { label: 'Insurance Attestation', icon: 'ti-shield-lock', accentColor: 'cyan', headline: 'Prepare for cyber insurance review', description: 'Generate underwriter-ready control and evidence reports.', planKey: 'BusinessUltimate' },
