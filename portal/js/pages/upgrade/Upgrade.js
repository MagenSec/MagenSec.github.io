...
const FEATURE_CATALOG = {
    ...
    InsuranceReadiness: { label: 'Insurance Attestation', icon: 'ti-shield-lock', accentColor: 'cyan', headline: 'Prepare for cyber insurance review', description: 'Generate underwriter-ready control and evidence snapshots.', planKey: 'BusinessUltimate' },
