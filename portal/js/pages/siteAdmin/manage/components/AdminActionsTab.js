        ...
        return [
            ...
            },
            {
                ...
                jobs: [
                    ...
                    mkJob({ groupId: 'intel', jobId: 'cve-feed-sync', title: 'CVE Feed Sync', description: 'Sync NVD CVE feeds and refresh enriched CVE intelligence.', taskId: 'CVE Sync' }),
            ...
            },
            {
                ...
                jobs: [
                    ...
                    mkJob({ groupId: 'maintenance', jobId: 'alert-purge', title: 'Alert Purge', description: 'Close active VULN alerts into retained history and resolve legacy rows. Queue Detection Engine separately when an immediate rebuild is needed.', taskId: 'Alert Purge', supportsOrg: true }),
            ...
            <div class="mt-3 pt-3 border-top">
                ...
                ${isOpen && html`
                    <div class="small text-muted mt-2">
                        ...
                        ` : html`<div>No status report available for this job yet.</div>`}
