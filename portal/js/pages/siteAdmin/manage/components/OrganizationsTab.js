                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    ${credits.hasSnapshot
                                                        ...
                                                        : html`<small class="text-muted">No credit report</small>`}
                                                </td>
                                                <td>
                                                                                                        ...
                                                                                                        <div class="card border border-light">
                                                                                                            ...
                                                                                                            <div class="card-body">
                                                                                                                <div class="row g-3">
                                                                                                                    ...
                                                                                                                    <div class="col-md-4">
                                                                                                                        <label class="form-label">Report Refresh Override (hrs)</label>
                                                                                                ...
                                                                                                <div class="row g-3">
                                                                                                    ...
                                                                                                    <div class="col-12">
                                                                                                        <div class="card border border-light">
                                                                                                            ...
                                                                                                            <div class="card-body">
                                                                                                                <p class="text-muted small mb-3">Move this organization's blob data (reports, attachments) to a different storage account or region. The background job copies blobs with checkpoint resumption — safe to reschedule if interrupted.</p>
