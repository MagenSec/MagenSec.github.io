...
export function BusinessPage() {
    ...
    const views = [
        { key: 'business', icon: 'ti-chart-dots-2', label: 'Business', description: 'Reports, billing, margin' },
            ...
            <div class="business-intelligence-header page-header d-print-none mb-3">
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <div class="text-white opacity-75 small mt-1">Business view is report-first. Current-day telemetry is displayed as indicative operating pressure only.</div>
                    </div>
            ...
            ${activeView === 'profitability' && html`
                <div class="d-flex align-items-center justify-content-between mb-3">
                    <div>
                        ...
                        <div class="text-muted small">Daily revenue, allocated COGS, package margins, and pricing scenarios from the same report/cost basis.</div>
                    </div>
                </div>
                <${ProfitabilityPage}
                    snapshot=${snapshot}
