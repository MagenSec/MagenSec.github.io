...
export function ExecutiveSummary({ snapshot, history, catalog, displayCcy, billingCcy, convert, ccySymbol }) {
    ...
    const azureCostAuthorityLabel = mtdAzureActualRaw > 0 ? 'Azure Cost API MTD' : `${actualCostDays}d daily reports`;
    ...
    const keyResults = [
        {
            ...
            ribbon: 'Window',
            tooltip: 'Azure daily cost trend for the selected window, sourced from Azure Cost API daily service totals when available and DAILY_COST reports as fallback.'
        },
        {
            label: 'Azure Actual',
            ...
            ribbon: 'Actual',
            tooltip: 'Financial authority for current billing-month Azure spend. This value is overlaid from Azure Cost Management even when the dashboard serves a cached report.'
        },
        {
            ...
            ribbon: 'Forecast',
            tooltip: 'Projected Azure end-of-month bill based on the current month-to-date Azure Cost API burn rate. If the live MTD value is unavailable, the selected daily report average is used.'
        },
        {
            label: 'Loaded EOM',
    ...
    return html`
        <div class="executive-summary">
            <div class="business-section-heading mb-2">
                ...
                <div class="business-section-note">Daily-report financial basis with Azure Cost actuals overlaid where current-month billing matters.</div>
            </div>

            <div class="business-health-strip mb-3" aria-label="Daily report business health">
            ...
            ${d.mrrChange != null && html`
                <div class="alert alert-light py-2 mb-3 d-flex gap-3 flex-wrap align-items-center small" style="color: var(--tblr-body-color, #182433);">
                    <span class="fw-medium text-muted me-1">Report Delta:</span>
            ...
            <div class="row g-3 mb-3 business-kpi-grid">
                ...
                <div class="col-sm-6 col-lg-3 d-flex">
                    <${KpiCard}
                        ...
                        subtitle=${activeDevices > 0 ? `${formatCompact(activeDevices)} seen in latest daily report` : 'registered fleet baseline'}
                    />
                </div>
                <div class="col-sm-6 col-lg-3 d-flex">
                    <${KpiCard}
