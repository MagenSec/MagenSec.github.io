...
export class DiagnosticsPage extends Component {
    ...
    renderSnapshotDiagnosticsView() {
        ...
        if (!snapshotDiagnostics) {
            return html`<div class="text-muted">No report diagnostics available</div>`;
        }
        ...
        return html`
            <div class="row row-cards mb-3">
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                            <div class="text-muted mb-1">Latest Report Date</div>
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                            <div class="text-muted mb-1">Report Age</div>
                            <div class="h2 mb-0">
            ...
            ${missingCount > 0 ? html`
                <div class="alert alert-danger mb-3" role="alert">
                    <div class="d-flex">
                        ...
                        <div>
                            Report gap detected in rolling 450-day coverage.
