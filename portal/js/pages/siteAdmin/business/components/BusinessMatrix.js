        ...
        <div class="business-matrix-container">
            ...
            <div class="row g-3 mb-4">
                ...
                <div class="col-md-4">
                    <div class="card h-100">
                        <div class="card-body text-center">
                            <div class="text-body-secondary small mb-2">Avg Daily Azure Spend (${kpiWindowDays}D) ${renderInfoTooltip('Average daily spend over selected time window using Azure Cost reports.')}</div>
            ...
            <!-- Section: High-Activity Devices -->
            ${metrics.noisyDevices?.length > 0 ? html`
                <div class="bm-section-header"><span>High-Activity Devices</span></div>
                <div class="card mb-4">
