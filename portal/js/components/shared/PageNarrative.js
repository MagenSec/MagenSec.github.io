...
const NARRATIVES = {
    ...
    compliance: {
        ...
        source: 'Compliance report, framework catalog, and trend evidence',
    ...
    posture: {
        ...
        answer: 'Report history exposes behavior: patch cadence, recurring gaps, remediation movement, and drift.',
        source: 'Posture report history and trend evidence',
    ...
    'posture-ai': {
        ...
        source: 'AI report payloads and underlying evidence',
        actionLabel: 'Open reports',
        actionHref: '#!/reports',
        focus: ['audit', 'hygiene']
    },
    ...
    'add-on/insurance-readiness': {
        ...
        source: 'Insurance readiness model and evidence reports',
        actionLabel: 'Open reports',
        actionHref: '#!/reports',
    ...
    'add-on/compliance-plus': {
        ...
        answer: 'Advanced compliance views expand control evidence beyond the base readiness report.',
    ...
    'add-on/peer-benchmark': {
        ...
        source: 'Peer cohorts, hygiene scores, and org reports',
