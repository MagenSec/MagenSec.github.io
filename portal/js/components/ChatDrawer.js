      ...
      >
        ...
        <div style="padding: 10px 14px; border-bottom: 1px solid var(--magi-border-soft); display: flex; flex-direction: column; gap: 4px; flex-shrink: 0; background: var(--magi-header-bg); color: var(--magi-text);">
          ...
          <div style="display: flex; align-items: center; gap: 8px; min-width: 0; padding-left: 26px;">
            ...
            ${rewindContext.isActive() ? html`<span style="margin-left: auto; font-size: 0.7rem; font-weight:600; color:#92400e; background:#fef3c7; padding: 1px 8px; border-radius: 999px; border: 1px solid #f59e0b;" title="Answering from the ${rewindContext.getDate()} report">⏪ ${rewindContext.getDate()}</span>` : ''}
